...
MODULES                = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c sldemo_suspn_3dof_capi.c sldemo_suspn_3dof_data.c sldemo_suspn_3dof_tgtconn.c 
MAKEFILE               = sldemo_suspn_3dof.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = D:\MATLAB Data
S_FUNCTIONS            = rtiostream_utils.c
S_FUNCTIONS_LIB        = $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwcoder_target_services.lib $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwcoder_ToAsyncQueueTgtAppSvc.lib $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwcoder_ParamTuningTgtAppSvc.lib
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
NCSTATES            = 6
MULTITASKING        = 0
PCMATLABROOT        = C:\\Program Files\\MATLAB\\R2016b
...
MODELLIB                  = sldemo_suspn_3doflib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = sldemo_suspn_3dof_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\sldemo_suspn_3dof

MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)

MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\simulink\simdemos\simfeatures
...
MAT_LIBS = $(MATLAB_ROOT)\extern\lib\win64\microsoft\libut.lib \
           ...
           $(MATLAB_ROOT)\extern\lib\win64\microsoft\sl_services.lib \
...
MAT_LIBS = $(MAT_LIBS) $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwsl_iofile.lib
